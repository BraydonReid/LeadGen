...
# Tier 0 (major metros 200k+)  → 50% of scraping slots
# Tier 1 (large cities 75k–200k) → 30% of slots
# Tier 2 (everything else)       → 20% of slots
# Cities not listed default to Tier 2.
_CITY_TIER: dict[str, int] = {
    # ── Tier 0: Major metros 200k+ ────────────────────────────────────────────
    "New York City": 0, "Los Angeles": 0, "Chicago": 0, "Houston": 0,
    "Phoenix": 0, "Philadelphia": 0, "San Antonio": 0, "San Diego": 0,
    "Dallas": 0, "San Jose": 0, "Austin": 0, "Jacksonville": 0,
    "Fort Worth": 0, "Columbus": 0, "Charlotte": 0, "Indianapolis": 0,
    "San Francisco": 0, "Seattle": 0, "Denver": 0, "Nashville": 0,
    "Oklahoma City": 0, "El Paso": 0, "Washington": 0, "Las Vegas": 0,
    "Louisville": 0, "Memphis": 0, "Portland": 0, "Baltimore": 0,
    "Milwaukee": 0, "Albuquerque": 0, "Tucson": 0, "Fresno": 0,
    "Sacramento": 0, "Mesa": 0, "Kansas City": 0, "Atlanta": 0,
    "Omaha": 0, "Colorado Springs": 0, "Raleigh": 0, "Long Beach": 0,
    "Virginia Beach": 0, "Minneapolis": 0, "Tampa": 0, "New Orleans": 0,
    "Bakersfield": 0, "Honolulu": 0, "Anaheim": 0, "Aurora": 0,
    "Santa Ana": 0, "Corpus Christi": 0, "Riverside": 0, "St. Louis": 0,
    "Pittsburgh": 0, "Anchorage": 0, "Cincinnati": 0, "St. Paul": 0,
    "Greensboro": 0, "Lincoln": 0, "Plano": 0, "Orlando": 0,
    "Jersey City": 0, "Chandler": 0, "Laredo": 0, "Norfolk": 0,
    "Madison": 0, "Durham": 0, "Lubbock": 0, "Winston-Salem": 0,
    "Garland": 0, "Hialeah": 0, "Scottsdale": 0, "Baton Rouge": 0,
    "North Las Vegas": 0, "Irvine": 0, "Birmingham": 0, "Rochester": 0,
    "Richmond": 0, "Spokane": 0, "Des Moines": 0, "Montgomery": 0,
    "Fremont": 0, "Glendale": 0, "Little Rock": 0, "Amarillo": 0,
    "Grand Rapids": 0, "Huntington Beach": 0, "Salt Lake City": 0,
    "Tallahassee": 0, "Huntsville": 0, "Worcester": 0, "Knoxville": 0,
    "Brownsville": 0, "Providence": 0, "Fort Lauderdale": 0,
    "Chattanooga": 0, "Rancho Cucamonga": 0, "Santa Rosa": 0,
    "Tempe": 0, "Cape Coral": 0, "Ontario": 0, "Akron": 0,
    "Overland Park": 0, "Yonkers": 0, "Tacoma": 0, "Irving": 0,
    "Shreveport": 0, "McKinney": 0, "Modesto": 0, "Fontana": 0,
    "Augusta": 0, "Moreno Valley": 0, "Fayetteville": 0,
    # ── Tier 1: Large cities 75k–200k ─────────────────────────────────────────
    "San Bernardino": 1, "Boise": 1, "Gilbert": 1, "Chesapeake": 1,
    "Peoria": 1, "Surprise": 1, "Elk Grove": 1, "Frisco": 1,
    "Grand Prairie": 1, "Mesquite": 1, "Carrollton": 1, "Denton": 1,
    "Richardson": 1, "Lewisville": 1, "Allen": 1, "Flower Mound": 1,
    "North Richland Hills": 1, "Beaumont": 1, "Waco": 1, "Midland": 1,
    "Odessa": 1, "Pasadena": 1, "Killeen": 1, "McAllen": 1,
    "Macon": 1, "Savannah": 1, "Marietta": 1, "Roswell": 1,
    "Albany": 1, "Syracuse": 1, "Buffalo": 1, "Newark": 1,
    "Paterson": 1, "Bridgeport": 1, "Hartford": 1, "New Haven": 1,
    "Alexandria": 1, "Roanoke": 1, "Hampton": 1, "Newport News": 1,
    "Cary": 1, "High Point": 1, "Concord": 1, "Henderson": 1,
    "Paradise": 1, "Spring Valley": 1, "Sunnyvale": 1, "Santa Clara": 1,
    "Roseville": 1, "Visalia": 1, "Torrance": 1, "Pasadena": 1,
    "Pomona": 1, "Hayward": 1, "Escondido": 1, "Sunnyvale": 1,
    "Salinas": 1, "Corona": 1, "Palmdale": 1, "Lancaster": 1,
    "Rockford": 1, "Joliet": 1, "Naperville": 1, "Elgin": 1,
    "Springfield": 1, "Peoria": 1, "Wichita": 1, "Topeka": 1,
    "Sioux Falls": 1, "Fargo": 1, "Columbia": 1, "Charleston": 1,
    "Lexington": 1, "Clarksville": 1, "Murfreesboro": 1, "Jackson": 1,
    "Shreveport": 1, "Baton Rouge": 1, "Lafayette": 1, "Lake Charles": 1,
    "Spokane Valley": 1, "Bellevue": 1, "Kent": 1, "Everett": 1,
    "Reno": 1, "Henderson": 1, "Paradise": 1, "Glendale": 1,
    "Tempe": 1, "Chandler": 1, "Gilbert": 1, "Peoria": 1,
    "Scottsdale": 1, "Mesa": 1, "Surprise": 1, "Avondale": 1,
    "Fort Collins": 1, "Lakewood": 1, "Thornton": 1, "Arvada": 1,
    "Westminster": 1, "Pueblo": 1, "Centennial": 1,
    "Oxnard": 1, "Fullerton": 1, "Orange": 1, "Simi Valley": 1,
    "Thousand Oaks": 1, "Victorville": 1, "Murrieta": 1, "Temecula": 1,
    "Antioch": 1, "Concord": 1, "Santa Rosa": 1, "Oceanside": 1,
    "Garden Grove": 1, "Huntington Beach": 1, "Santa Ana": 1,
}


def _city_tier(city: str) -> int:
    """Return the population tier for a city: 0 = major, 1 = large, 2 = small."""
    return _CITY_TIER.get(city, 2)
...
def _select_targets(history: dict) -> list[tuple[str, str, str, str]]:
    ...
    Slots are split by city population tier so major metros always get priority:
      Tier 0 (200k+ pop) → 50% of slots
      Tier 1 (75k–200k)  → 30% of slots
      Tier 2 (<75k)      → 20% of slots
    ...
    # Build per-tier, per-industry candidate pools
    by_industry: dict[int, dict[str, list[tuple]]] = {0: defaultdict(list), 1: defaultdict(list), 2: defaultdict(list)}
    for canonical, terms in INDUSTRIES.items():
        for state, cities in active_locations.items():
            for city in cities:
                ...
                by_industry[tier][canonical].append((last_scraped, -demand_w, terms, city, state))

    for tier_pools in by_industry.values():
        for combos in tier_pools.values():
            combos.sort(key=lambda x: (x[0], x[1]))

    # Slot budget per tier: 50% / 30% / 20%
    tier_budgets = {
        0: int(TARGETS_PER_RUN * 0.50),
        1: int(TARGETS_PER_RUN * 0.30),
        2: TARGETS_PER_RUN - int(TARGETS_PER_RUN * 0.50) - int(TARGETS_PER_RUN * 0.30),
    }

    def _pick_from_tier(tier: int, budget: int) -> list[tuple[str, str, str, str]]:
        tier_pools = by_industry[tier]
        if not tier_pools:
            return []
        industries = list(tier_pools.keys())
        ...
        while len(picked) < budget:
            ...
            for ind in industries:
                ...
                if round_idx < len(pool):
                    ...
                    picked.append((ind, search_term, city, state))
                    made_progress = True
    ...
    selected = []
    for tier in (0, 1, 2):
        selected.extend(_pick_from_tier(tier, tier_budgets[tier]))
