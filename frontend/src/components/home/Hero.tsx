    ...
    <section className="bg-gradient-to-br from-slate-900 via-slate-800 to-blue-900 text-white">
      <div className="max-w-6xl mx-auto px-6 py-24 lg:py-32">
        <div className="max-w-3xl">
          ...
          <p className="text-lg lg:text-xl text-slate-300 mb-10 leading-relaxed">
            Browse our database of <strong className="text-white">{formatted} verified contacts</strong> —
            business directories and{" "}
            <span className="text-teal-400 font-semibold">consumer intent leads</span> from homeowners
            actively seeking services. Filter by location, pick your quantity, and download your CSV instantly.
          ...
          <div className="flex flex-wrap gap-6 text-sm text-slate-400">
            {["No subscription required", "Instant CSV download", "Pay only for what you need", "50+ industries"].map(
              (item) => (
      ...
      <div className="border-t border-white/10 bg-black/20">
        <div className="max-w-6xl mx-auto px-6 py-6 grid grid-cols-2 md:grid-cols-5 gap-6 text-center">
          {[
            { value: formatted, label: "Leads available" },
